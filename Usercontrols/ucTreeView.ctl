...
Attribute InsertMarkColor.VB_MemberFlags = "400"
    If (m_hTreeView) Then
...
Private Function pvTVAddNode( _
                 ...
                 sText As String, _
                 lImage As Long, _
                 lSelectedImage As Long, _
                 bForcePlusButton As Boolean _
                 ) As Long
...
Private Function pvTVGetText(hNode As Long) As String
  ...
  Dim aBuf() As Byte
    ...
    End If
End Function
Private Sub pvTVSetText(hNode As Long, sText As String)
...
Private Function pvTVGetlParam(hNode As Long) As Long
  ...
  Dim uTVI As TVITEM
    ...
    End If
End Function
Private Sub pvTVSetlParam(hNode As Long, lParam As Long)
...
Private Function pvTVGetImage(hNode As Long) As Long
  ...
  Dim uTVI As TVITEM
    ...
    End If
End Function
Private Sub pvTVSetImage(hNode As Long, lImage As Long)
...
Private Function pvTVGetSelectedImage(hNode As Long) As Long
  ...
  Dim uTVI As TVITEM
    ...
    End If
End Function
Private Sub pvTVSetSelectedImage(hNode As Long, lSelectedImage As Long)
...
Private Function pvTVGetStateImage(hNode As Long) As Long
  ...
  Dim uTVI As TVITEM
    ...
    End If
End Function
Private Sub pvTVSetStateImage(hNode As Long, lIndex As Long)
...
Private Function pvTVGetcChildren(hNode As Long) As Long
  ...
  Dim uTVI As TVITEM
    ...
    End If
End Function
Private Sub pvTVSetcChildren(hNode As Long, cChildren As Long)
...
Private Function pvTVHitTest(hNode As Long, lfHit As Long) As Long
...
Private Function pvTVHasChildren(hNode As Long) As Boolean

    pvTVHasChildren = CBool(SendMessageLong(m_hTreeView, TVM_GETNEXTITEM, TVGN_CHILD, hNode))
End Function

Private Sub pvTVGetItemRect(hNode As Long, uRect As RECT2)
...
Private Function pvStringFromPointer(pszText As Long, ByVal cchTextMax As Long) As String
...
Attribute OLEDragAutoExpand.VB_MemberFlags = "400"
...
Attribute OLEDragInsertStyle.VB_MemberFlags = "400"
...
Attribute OLEDragMode.VB_MemberFlags = "400"
...
Attribute OLEDropMode.VB_MemberFlags = "400"
    ...
    If (Len(sData) > 6) Then
        ...
        If (lhWndPos = 1) Then
            ...
            If (lhNodePos >= 4) Then
                ...
                '-- Success ?
                OLEGetDragInfo = (hWndTreeView And hNodeDrag)
            End If
        End If
    End If
End Function
